...
export type GradSubtractIO = {
  psi: GPUBuffer;
  u: GPUBuffer; v: GPUBuffer; w: GPUBuffer; // corrected in-place
};
...
fn main(@builtin(global_invocation_id) gid: vec3<u32>){
  ...
  let dpsi_dx = (psi[i_xp] - psi[i_xm]) * Ubuf.inv2dx;
  let dpsi_dy = (psi[i_yp] - psi[i_ym]) * Ubuf.inv2dy;
  let dpsi_dz = (psi[i_zp] - psi[i_zm]) * Ubuf.inv2dz;
